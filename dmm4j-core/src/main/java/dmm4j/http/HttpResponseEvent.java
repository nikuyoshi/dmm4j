...
public final class HttpResponseEvent {
  ...
  private final DmmException dmmException;

  HttpResponseEvent(HttpRequest request, HttpResponse response, DmmException de) {
    this.request = request;
    this.response = response;
    this.dmmException = de;
  }
  ...
  /**
   * returns the DmmException associated with the event
   *
   * @return the DmmException associated with the event
   */
  public DmmException getDmmException() {
    return dmmException;
  }
