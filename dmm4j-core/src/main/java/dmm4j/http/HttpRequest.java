...
public final class HttpRequest implements java.io.Serializable {
   ...
   * @param authorization Authentication implementation. Currently BasicAuthentication,
   *        OAuthAuthentication and NullAuthentication are supported.
  ...
  public String toString() {
    return "HttpRequest{" + "requestMethod=" + method + ", url='" + url + '\'' + ", postParams="
        + (parameters == null ? null : Arrays.asList(parameters)) + ", requestHeaders="
        + requestHeaders + '}';
  }
}
